          ...
          <select id="sortedWaypointsDropdown2">
           ...
           <div class="card-grid">
               ...
               <div class="card">
                ...
                <div class="card">
                    <p class="card-title">Mako Total Sensor Read (us)</p>
                    <p class="reading"><span id="total_sensor_read"></span></p>
                </div>
                <div class="card">
                    <p class="card-title">Mako Compass Read (us)</p>
                    <p class="reading"><span id="compass_read"></span></p>
                </div>
                <div class="card">
                    <p class="card-title">Mako Temp/Humidity Read (us)</p>
                    <p class="reading"><span id="temphumid_read"></span></p>
                </div>
                <div class="card">
                    <p class="card-title">Mako IMU Read (us)</p>
                    <p class="reading"><span id="imu_read"></span></p>
                </div>
                <div class="card">
                    <p class="card-title">Mako Colour Read (us)</p>
