...
OLEDGSDisplayManager::OLEDGSDisplayManager(Adafruit_SSD1327& adafruitDisplay)
    : display(adafruitDisplay)
{
}

OLEDGSDisplayManager::~OLEDGSDisplayManager() {
}


void OLEDGSDisplayManager::clearDisplay() {
  display.clearDisplay();
  display.display();
}


void OLEDGSDisplayManager::fullDisplayTest() {
...
void OLEDGSDisplayManager::testdrawbitmap(const uint8_t *bitmap, uint8_t w, uint8_t h, uint32_t maxFrames) {
  uint8_t icons[NUMFLAKES][3];
  randomSeed(666);     // whatever seed

  if (!maxFrames)
    maxFrames = -1;   // very large number!
...
void OLEDGSDisplayManager::testdrawchar(void) {
  display.setTextSize(1);
  ...
  void OLEDGSDisplayManager::testdrawcircle(void) {
  ...
  void OLEDGSDisplayManager::testfillrect(void) {
  uint8_t color = 1;
  ...
  void OLEDGSDisplayManager::testdrawtriangle(void) {
...
void OLEDGSDisplayManager::testfilltriangle(void) {
...
void OLEDGSDisplayManager::testdrawroundrect(void) {
...
void OLEDGSDisplayManager::testfillroundrect(void) {
  // uint8_t color = SSD1327_WHITE;
  for (uint8_t i=0; i<display.height()/3-2; i+=2) {
...
void OLEDGSDisplayManager::testdrawrect(void) {
  ...
  void OLEDGSDisplayManager::testdrawline() {  
